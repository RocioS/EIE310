...
xlabel('t [seg]'); ylabel('Amp'); grid 
title('[b]  Secuencia ingresada a la FFT') % Calcula la magnitud del espectro 
X = fft(x);                  % FFT
...
title('[c]  Magnitud del espectro') % Gráfico [d]: espectro ampliado (zoom) en frecuencias bajas 
