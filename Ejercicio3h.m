...
ab = [1 0 1 0 1]; % amplitudes deseadas en las bandas
% Ripple en las bandas
r1b = 3; r2b = 40; r3b = 3; r4b = 40; r5b=3;
% Desviaciones en las bandas
d2b = 10^(-r2b/20);
d1b = (10^(r1b/20)-1)/(10^(r1b/20)+1);
d4b = 10^(-r4b/20);
d5b = (10^(r5b/20)-1)/(10^(r5b/20)+1);
d3b = (10^(r3b/20)-1)/(10^(r3b/20)+1);
devb = [d1b d2b d3b d4b d5b]; % vector de desviaciones
[Ob, fob, aob, wb] = remezord(fb, ab, devb, Fs); % estima orden del filtro
Ob % despliega orden = (N-1)
bb = remez(Ob, fob, aob,wb);%diseña el filtro
[H, f] = freqz(b, 1, 1024, Fs);
[J, fb] = freqz(bb, 1, 1024, Fs);
plot(f, 20*log10(abs(H)),'b',fb,20*log10(abs(J)),'r'); xlabel('Hz'); ylabel('dB'); grid
